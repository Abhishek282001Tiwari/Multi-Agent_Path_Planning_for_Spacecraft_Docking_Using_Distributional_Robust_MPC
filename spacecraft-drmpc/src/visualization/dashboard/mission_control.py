...
from ...monitoring.system_logger import get_component_logger, ComponentType
from ...monitoring.telemetry_collector import TelemetryCollector, SpacecraftState, MissionPhase
from ...monitoring.health_monitor import HealthMonitor, ComponentHealth, HealthStatus
...
class MissionControlDashboard:
    ...
    def _process_telemetry_data(self, telemetry_point):
        ...
        from ...monitoring.telemetry_collector import TelemetryType
...
if __name__ == "__main__":
    import threading
    import time
    from ...monitoring.telemetry_collector import TelemetryCollector, TelemetryPoint, TelemetryType, SpacecraftState
    from ...monitoring.health_monitor import start_health_monitoring
    from ...monitoring.performance_metrics import start_monitoring
