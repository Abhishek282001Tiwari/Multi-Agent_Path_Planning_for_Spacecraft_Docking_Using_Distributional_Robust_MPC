...
from ...monitoring.telemetry_collector import TelemetryPoint, TelemetryType, SpacecraftState
...
if __name__ == "__main__":
    ...
    # Simulate some data
    import random
    from ...monitoring.telemetry_collector import TelemetryPoint, TelemetryType, SpacecraftState, MissionPhase
